...
public class ItemDetailServiceImpl implements ItemDetailService {
    ...
    @Autowired
    private RestDmSchedulerSeatClient dmSchedulerSeatClient;
    @Autowired
    ...
    public Dto<List<ItemPriceVo>> queryItemPrice(Long id) throws Exception {
        ...
        //根据排期ID查询排期价格信息
        List<DmSchedulerSeatPrice> dmSchedulerSeatPriceList = dmSchedulerSeatPriceClient.getDmSchedulerSeatPriceListByMap(param);
        ...
        for (DmSchedulerSeatPrice dmSchedulerSeatPrice : dmSchedulerSeatPriceList) {
            ...
            int num = dmSchedulerSeatClient.getDmSchedulerSeatCountByMap(lockMap);
    ...
    public Dto<ItemDetailVo> queryItemDetail(Long id) throws Exception {
        ...
        //查询图片
        List<DmImage> dmImageList = dmImageClient.queryDmImageList(dmItem.getId(), Constants.Image.ImageType.carousel, Constants.Image.ImageCategory.item);
        //查询剧院
