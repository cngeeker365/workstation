...
public class RestDmSchedulerSeatPriceService {
    ...
    public DmSchedulerSeatPrice getDmSchedulerSeatPriceBySchedulerIdAndArea(@RequestParam("scheduleId") Long scheduleId, @RequestParam("areaLevel") Integer areaLevel) throws Exception{
         return dmSchedulerSeatPriceMapper.getDmSchedulerSeatPriceBySchedulerIdAndArea(scheduleId, areaLevel);
    }
}
