...
public interface DmSchedulerSeatPriceMapper {
	...
	public DmSchedulerSeatPrice getDmSchedulerSeatPriceBySchedulerIdAndArea(@Param(value = "scheduleId") Long scheduleId, @Param(value = "areaLevel") Integer areaLevel) throws Exception;
