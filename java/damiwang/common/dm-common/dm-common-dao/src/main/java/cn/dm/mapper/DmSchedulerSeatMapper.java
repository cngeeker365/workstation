...
public interface DmSchedulerSeatMapper {
	...
	public DmSchedulerSeat getDmSchedulerSeatByOrder(@Param(value = "scheduleId") Long scheduleId, @Param(value = "x") Integer x, @Param(value = "y") Integer y) throws Exception;
